...
def IA(image):
    ...
    remontar(tile_dir=Caminho.Caminho.IMG_MERGED.value, tile_height=640, tile_width=640, tiles_per_col=11, tiles_per_row=11, filler_color=(0, 0, 0))
    remontar(tile_dir=Caminho.Caminho.IMG_MARK.value, tile_height=640, tile_width=640, tiles_per_col=11, tiles_per_row=11, filler_color=(0, 0, 0), tile_name="NIR_masked_output_0", final_file_name="mask_image_final")
