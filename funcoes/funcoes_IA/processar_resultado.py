...
def processar_resultado(results, image, nome_imagem_original, nuvem_tela_inteira):
    ...
    if nuvem_tela_inteira:
        ...
        if custom_mask is not None:
            ...
            # Define o novo caminho para a máscara personalizada
            output_mask_path = f"./IA/img_mark/{nome_imagem_original}_masked_output_custom.png"
            
            # Salva a imagem redimensionada no caminho de saída
