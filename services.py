...
def processar_imagem_com_ia(image_path):
    ...
    print(f"[INFO] Imagem tratada convertida para BGR: {imagem_tratada.shape}")
    return imagem_sem_nuvem, imagem_sem_sombra, imagem_nuvem, imagem_sombra, thumbnail_sem_nuvem, thumbnail_sem_sombra, thumbnail_nuvem, thumbnail_sombra, thumbnail_imagem, percent, imagem_tratada, thumbnail_imagem_original
...
def montar_json_response(data, percent, data_atual, hora_atual, id_usuario, imagem_sem_nuvem_url, imagem_sem_sombra_url, imagem_nuvem_url, imagem_sombra_url, thumbnail_sem_nuvem_url, thumbnail_sem_sombra_url, thumbnail_nuvem_url, thumbnail_sombra_url, thumbnail_imagem_url, imagem_tratada, thumbnail_imagem_original_url):
